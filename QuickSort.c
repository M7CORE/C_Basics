// Arup Guha
// First written in Summer of 2007.
// Edited on 3/26/2010 to streamline quicksort function.
/*** Edited on 11/8/2013 to compare to bubble sort ***/
...
//        list[i] = rand();
    ...
    if (RUNQUICK)
        ...
        printf("Bubble Sort took %d seconds.\n", tfinish-tstart);
    free(list);
    return 0;
}
